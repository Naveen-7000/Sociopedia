  ...
  emailOrPhone: yup.string()
    .test(
      ...
      function (value) {
        ...
        if (!value) {
          // field is empty, not an error but validation fails
          return false;
        }
      ...
      {({
        ...
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            />
            <TextField
              label={isRegister ? "Email" : "Email Or Phone"}
              onBlur={handleBlur}
              onChange={handleChange}
              value={values.email}
              name="email"
           ...
           {isLogin&& (
            ...
            <TextField
              ...
              name="emailOrPhone"
              error={Boolean(touched.emailOrPhone)  && Boolean(errors.emailOrPhone) }
          ...
          <Box>
            ...
            >
              {isLogin
                ...
                {
                  isLogin && "Dummy acount : emailOrPhone : abhisekgowtam12@gmail.com | 8882784648 Password : 123456789"
                }
          </Box>
        </form>
      )}
